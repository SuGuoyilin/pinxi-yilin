...
function renderScheduleMain() {
  ...
  // 构建表格
  var html = '<table><thead><tr>';
  html += '<th class="freeze-col th-freeze" style="min-width:30px;"><input type="checkbox" onchange="toggleAllScheduleRows(this)"></th>';
  ...
  html += '<th class="freeze-right th-freeze-right" style="min-width:42px;">工时</th>';
  html += '<th class="freeze-right th-freeze-right" style="min-width:42px;">出勤</th>';
  html += '</tr></thead><tbody>';
...
function renderHrProjects() {
  ...
  var html = '<div class="hr-tableWrap" style="overflow-x:auto;"><table id="hrProjTable"><colgroup>' +
    '<col style="width:100px;"><col><col><col style="width:90px;"><col style="width:90px;">' +
  ...
  for (var i = 0; i < projects.length; i++) {
    ...
    html += '<tr style="' + rowStyle + '">' +
      '<td class="hr-cellEdit"><input value="' + esc(p) + '" data-idx="' + i + '" onchange="updateHrProject(this)"></td>' +
      '<td><select class="hr-select" data-idx="' + i + '" onchange="updateHrProjectType(this)">' +
  ...
  if (projects.length === 0) {
    html += '<tr><td colspan="16" class="empty-cell">暂无项目</td></tr>';
  }
